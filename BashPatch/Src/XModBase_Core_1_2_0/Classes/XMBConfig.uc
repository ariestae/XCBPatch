...
// These configuration variables go in the [XModBase_Core_1_2_0.XMBConfig] section of
...
defaultproperties
{
	...
	// ExtraUnitConditions in XComGameCore.ini, section [XModBase_Core_1_2_0.XMBConfig].
